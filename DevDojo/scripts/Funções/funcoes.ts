// Criando uma função
function funcPrint(valor: string): void {
    console.log(valor)
}
funcPrint('Hello')
...
const sumAnonymous = function (n1: number, n2: number): void {
    console.log(`sum: ${n1+n2}`)
}
sumAnonymous(1,2)

// Arrow Functions
const sumArrow1 = (n1: number, n2: number) => n1 + n2
const sumArrow2 = (n1: number, n2: number): number => {
    return n1 + n2
}
